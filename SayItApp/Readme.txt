I am creating tutorial on “Cool uses of Polly, Rekognition”.
...
Now we are good to run the “labels_graphical.py”. Don’t run the “Doctests in labels_graphical.py”, make the changes suggest by Professor in Mid Term.
